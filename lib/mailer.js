...
module.exports = function (context) {
  ...
  var test_fail_plaintext = renderJade(path.join(__dirname, '../views', 'email_templates', 'plaintext', 'test_fail.jade'));
  var test_succeed_plaintext = renderJade(path.join(__dirname, '../views', 'email_templates', 'plaintext', 'test_succeed.jade'));
